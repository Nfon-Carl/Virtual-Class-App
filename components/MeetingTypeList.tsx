...
const MeetingTypeList = () => {
  ...
  return (
    <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
        ...
        <HomeCard img="/icons/recordings.svg" title="View recordings" description = "Check Out Your Recordings" handleClick={()=>setMeetingState('isJoiningMeeting')} className="bg-purple-1"/>
